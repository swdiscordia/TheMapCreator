...
namespace GAF.Managed.Editor.Assets
{
	...
	public class GAFResourceManagerInternal
	{
		...
		{
			// NOTE: This is reference code only - not in active use
			if (!m_ImportList.Contains(_Importer.assetPath))
			{
				...
				// _Importer.textureFormat  = TextureImporterFormat.AutomaticTruecolor; // Obsolete
				_Importer.textureCompression = TextureImporterCompression.Uncompressed; // Modern equivalent
